...
const LabelHeader = () => {
    ...
    return (
        <div className='absolute  inset-0 flex justify-center items-center w-full h-dvh bg-[var(--white-smoke)] '>
            <div
                ref={scope}
                className='absolute top-5 left-3 translate-x-[1000px] translate-y-[200px] -rotate-5 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)]'>
                <BlueLabel />
            </div>
            <div className='absolute top-5 left-3 translate-x-[200px] translate-y-[500px] rotate-5 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)]'>
                <RedLabel />
            </div>
            <div className='absolute top-[600px] left-[980px] rotate-5 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)]'>
                <YellowLabel />
            </div>
